...
export const ds = new DataSource('config.cargos', { includeEnum: true });
...
function borrar(id)
{
    ...
    Api.fetch('config/cargos/borrar', { id }).then(r => {
...
export default () => 
    <r-panel class="flex-fill" data-route="/config/cargos/listar/" onPanelShown={ onShown }>

        <h1>Cargos de la Empresa</h1>

        <Paginacion dataSource={ ds }>
            <a class="btn alt-1" href="#/config/cargos/crear/"><i class="fa-solid fa-plus"></i> Crear Cargo</a>
        </Paginacion>
            ...
            <tbody class="x-data" content={ (item) =>
                <tr>
                    ...
                    <td style:textAlign="center">
                        <a class="btn-1 btn-blue" href={"#/config/cargos/editar/"+item.id}><i class="fa-regular fa-pen-to-square"></i></a>
