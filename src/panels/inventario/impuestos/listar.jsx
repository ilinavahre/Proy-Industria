...
export const ds = new DataSource('inventario.impuestos', { includeEnum: true });
...
function borrar(id)
{
    ...
    Api.fetch('inventario/impuestos/borrar', { id }).then(r => {
...
export default () => 
    <r-panel class="flex-fill" data-route="/inventario/impuestos/listar/" onPanelShown={ onShown }>

        <Paginacion dataSource={ ds }>
            <a class="btn alt-1" href="#/inventario/impuestos/crear/"><i class="fa-solid fa-plus"></i> Crear Impuesto</a>
        </Paginacion>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th data-sort="name"><span>Nombre de Impuesto</span></th>
                    <th data-sort="value"><span>Porcentaje</span></th>
            ...
            <tbody class="x-data" content={ (item) =>
                <tr>
                    ...
                    <td style:textAlign="center">
                        <a class="btn-1 btn-blue" href={"#/inventario/impuestos/editar/"+item.id}><i class="fa-regular fa-pen-to-square"></i></a>
