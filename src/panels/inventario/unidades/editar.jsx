...
function onShown({ id })
{
    ...
    Api.fetch('inventario/unidades/leer', { id }).then(r =>
    {
...
// *********************************************
export default () => 
    <r-panel class="flex-fill" data-route="/inventario/unidades/editar/:id" onPanelShown={ onShown }>

        <div class="buttons">
            <a class="btn alt-1" onClick={ back }><i class="fa-solid fa-arrow-left-long"></i> Regresar</a>
        </div>

        <r-form class="form" data-form-action="inventario.unidades.guardar" onFormSuccess={ formSuccess } onCreated={ f=>form=f }>
