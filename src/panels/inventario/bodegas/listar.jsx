...
export const ds = new DataSource('inventario.bodegas', { includeEnum: true });
...
function borrar(id)
{
    ...
    Api.fetch('inventario/bodegas/borrar', { id }).then(r => {
...
export default () => 
    <r-panel class="flex-fill" data-route="/inventario/bodegas/listar/" onPanelShown={ onShown }>

        <Paginacion dataSource={ ds }>
            <a class="btn alt-1" href="#/inventario/bodegas/crear/"><i class="fa-solid fa-plus"></i> Registrar Bodega</a>
        </Paginacion>
            ...
            <tbody class="x-data" content={ (item) =>
                <tr>
                    ...
                    <td style:textAlign="center">
                        <a class="btn-1 btn-blue" href={"#/inventario/bodegas/editar/"+item.id}><i class="fa-regular fa-pen-to-square"></i></a>
