...
import { enumEstado } from '../compras/listar';
...
function onShown({ id })
{
    ...
    Api.fetch('inventario/compras/leer', { id }).then(r =>
    {
...
// *********************************************
export default () => 
    <r-panel class="flex-fill" data-route="/inventario/compras/actualizar/:id" onPanelShown={ onShown }>

        <div class="buttons">
            <a class="btn alt-1" onClick={ back }><i class="fa-solid fa-arrow-left-long"></i> Regresar</a>
        </div>

        <r-form class="form" data-form-action="inventario.compras.actualizar" onFormSuccess={ formSuccess } onCreated={ f=>form=f }>
