...
// *********************************************
export default () => 
    <r-panel class="flex-fill" data-route="/inventario/compras/editar/:id" onPanelShown={ onShown }>
        ...
        <div className="flex-row" style:gap="2rem">
            <r-form class="form" data-form-action="inventario.compras.guardar" onBeforeSubmit={ beforeSubmit } onFormSuccess={ formSuccess } onCreated={ f=>form=f }>
