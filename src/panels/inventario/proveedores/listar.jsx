...
export const ds = new DataSource('inventario.proveedores', { includeEnum: true });
...
function borrar(id)
{
    ...
    Api.fetch('inventario/proveedores/borrar', { id }).then(r => {
...
export default () => 
    <r-panel class="flex-fill" data-route="/inventario/proveedores/listar/" onPanelShown={ onShown }>

        <Paginacion dataSource={ ds }>
            <a class="btn alt-1" href="#/inventario/proveedores/crear/"><i class="fa-solid fa-plus"></i> Registrar Proveedor</a>
        </Paginacion>
            ...
            <tbody class="x-data" content={ (item) =>
                <tr>
                    ...
                    <td style:textAlign="center">
                        <a class="btn-1 btn-blue" href={"#/inventario/proveedores/editar/"+item.id}><i class="fa-regular fa-pen-to-square"></i></a>
